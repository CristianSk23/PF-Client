...
const PaymentGateway = () => {
  ...
  useEffect(() => {
    const conditionsMet =
      !isLoading && !isAuthenticated && isUser === "Invited";
            ...
            <form className="needs-validation" onSubmit={purchaseHandler}>
              <div className="row g-3">
                ...
                <div className="col-sm-6">
                  ...
                  <input
                    ...
                    className="form-control"
                    id="identityCard"
                    placeholder="Enter your identy card..."
                    name="identityCard"
                ...
                <div className="col-6">
                  ...
                  />
                  <div class="invalid-feedback">
                    Address must contain at least 4 consecutive numbers and more
                    than 5 letters.
                  </div>
                </div>
              ...
              <div className="text-center" style={{ marginTop: "-16px" }}>
                <div className="d-flex justify-content-center">
                  ...
                  <a
                    className="btn btn-danger mx-2 btn-md"
                    type="button"
                    style={{ margin: "8px", width: "180px" }}
