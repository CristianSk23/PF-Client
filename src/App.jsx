...
import AdminModuleHistoryOrderUser from "./components/adminModuleHistoryOrderUser/AdminModuleHistoryOrderUser"
    ...
    <div>
      <Routes>
        <Route>
          ...
          <Route path="/adminPanel/users/orderHistory/:id" element={<AdminModuleHistoryOrderUser/>} />
        </Route>
      </Routes>
    </div>
  );
